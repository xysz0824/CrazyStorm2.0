    ...
    internal class D3D9 : IDisposable
    {
        ...
        public D3D9()
        {
            ...
            PresentParameters presentParameters = new PresentParameters()
            {
                ...
                BackBufferWidth = 1,
                BackBufferHeight = 1,
                DeviceWindowHandle = D3D9.GetDesktopWindow()
            };
            _device = new DeviceEx(_direct3D, 0, DeviceType.Hardware, IntPtr.Zero, CreateFlags.FpuPreserve | CreateFlags.Multithreaded | CreateFlags.HardwareVertexProcessing, presentParameters);
        }
        ...
        /// supported.
        /// </exception>
        public SharpDX.Direct3D9.Texture GetSharedTexture(Texture2D renderTarget)
        {
            ThrowIfDisposed();
            if (renderTarget == null) return null;
            IntPtr sharedHandle = renderTarget.GetSharedHandle();
            ...
            switch (renderTarget.Format)
            {
                ...
                case SurfaceFormat.Bgra32:
                    ...
                    break;
                default:
                    throw new ArgumentException("Unexpected surface format. Supported formats are: SurfaceFormat.Bgr32, SurfaceFormat.Bgra32.", nameof(renderTarget));
            }
            return new SharpDX.Direct3D9.Texture((Device)_device, renderTarget.Width, renderTarget.Height, 1, Usage.RenderTarget, format, Pool.Default, ref sharedHandle);
        }
